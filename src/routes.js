...
let routes = [
    ...
    //{ path: '/main', component: Main },
    {
        ...
        children: [
            ...
            { path: '/equipmentRecord',component: resolve => require(['./views/desktop/EquipmentRecord.vue'], resolve), name: '报警推送记录' },
            { path: '/equipment',component: resolve => require(['./views/desktop/Equipment.vue'], resolve), name: '设备管理' },
            { path: '/equipmentMap',component: resolve => require(['./views/desktop/EquipmentMap.vue'], resolve), name: '设备管理列表' },
            { path: '/equipmentMapSelect',component: resolve => require(['./views/desktop/EquipmentMapSelect.vue'], resolve), name: '获取经纬度' },
